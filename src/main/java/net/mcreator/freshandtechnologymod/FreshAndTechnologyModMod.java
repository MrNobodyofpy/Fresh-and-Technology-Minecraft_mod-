 ...
 *
 */
package net.mcreator.freshandtechnologymod;
...
@Mod("fresh_and_technology_mod")
public class FreshAndTechnologyModMod {
	public static final Logger LOGGER = LogManager.getLogger(FreshAndTechnologyModMod.class);
	public static final String MODID = "fresh_and_technology_mod";

	public FreshAndTechnologyModMod() {
